...
module DracoonGrammar
	...
	public
		def customCutdown(node, children)
			if node.is_a? HeaderNode or node.is_a? SceneNode
				children << node
	...
	public
		def customCutdown(node, children)
			if node.is_a? IdentifierNode or node.is_a? StateNode or node.is_a? DescriptionNode or node.is_a? ScriptNode
				children << node
			elsif node.nonterminal?
				node.elements.each do |e| self.customCutdown(e, children) end
			end
	...
	public
		def customCutdown(node, children)
			if node.is_a? HeaderNode or node.is_a? PassageNode or node.is_a? ObjectNode or node.is_a? ScriptNode
				children << node
			elsif node.nonterminal?
				node.elements.each do |e| self.customCutdown(e, children) end
			end
	...
	class ObjectNode < Treetop::Runtime::SyntaxNode
	public
		def customCutdown(node, children)
			if node.is_a? ContentNode or node.is_a? HeaderNode or node.is_a? ActionNode then
				children << node
    ...
    class DescriptionNode < Treetop::Runtime::SyntaxNode
	public
		def cutdown
